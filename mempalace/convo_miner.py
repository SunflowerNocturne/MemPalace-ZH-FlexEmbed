    ...
    while i < len(lines):
        ...
        if line.strip().startswith(">"):
            ...
            if len(content) > CHUNK_SIZE:
                ...
                if len(first_part.strip()) > MIN_EXCHANGE_CHUNK_SIZE:
                ...
                while remainder:
                    ...
                    if len(part.strip()) > MIN_EXCHANGE_CHUNK_SIZE:
                        chunks.append({"content": part, "chunk_index": len(chunks)})
            elif len(content.strip()) > MIN_EXCHANGE_CHUNK_SIZE:
                chunks.append(
                    {
                        "content": content,
